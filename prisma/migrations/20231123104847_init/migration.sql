...
-- CreateIndex
CREATE INDEX "Chat_memberTwoId_idx" ON "Chat"("memberTwoId");

-- CreateIndex
CREATE UNIQUE INDEX "Chat_memberOneId_memberTwoId_key" ON "Chat"("memberOneId", "memberTwoId");

-- CreateIndex
CREATE INDEX "DirectChat_memberId_idx" ON "DirectChat"("memberId");

-- CreateIndex
CREATE INDEX "DirectChat_chatId_idx" ON "DirectChat"("chatId");
...
-- AddForeignKey
ALTER TABLE "Chat" ADD CONSTRAINT "Chat_memberOneId_fkey" FOREIGN KEY ("memberOneId") REFERENCES "Member"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Chat" ADD CONSTRAINT "Chat_memberTwoId_fkey" FOREIGN KEY ("memberTwoId") REFERENCES "Member"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "DirectChat" ADD CONSTRAINT "DirectChat_memberId_fkey" FOREIGN KEY ("memberId") REFERENCES "Member"("id") ON DELETE CASCADE ON UPDATE CASCADE;
